		...
		<div class="col-md-3">
			<div class="box box-primary">
				<div class="box-body box-profile">
					<?php if ($this->session->userdata("url_foto_perfil")): ?>
						<img class="profile-user-img img-responsive img-circle" src="<?php echo base_url("assets/images/users/".$this->session->userdata("url_foto_perfil")."/profile_160x160.jpg") ?>" alt="Foto de perfil">
					<?php else: ?>
					...
					<?php endif; ?>
					<h3 class="profile-username text-center"><?php echo $this->session->userdata("completo") ?></h3>
