	...
	<div class="content">
		<div class="form-container">
			...
			<form id="frmRegistro" action="<?php echo base_url("inicio/crear")?>" method="post">	
				...
				<div class="form-group col-md-4 fieldset">
					<input type="text" class="required phone Numeros" id="txtTelefono" name="txtTelefono" maxlength="10">
...
<script src="<?php echo base_url("assets/js/app/registro.js") ?>"></script>