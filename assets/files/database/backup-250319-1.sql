...
CREATE TABLE `empleados` (
  ...
  `descripcion` text COMMENT 'Descripcion del empleado',
...
insert  into `empleados`(`id`,`nombre`,`a_paterno`,`a_materno`,`telefono`,`correo`,`rfc`,`nss`,`url_foto`,`descripcion`,`f_registro`,`id_usuario`,`status`) values (1,'Valeria','Altamirano','Palacios','6699129707','2016030063@upsin.edu.mx','ANV980321PAAL','70169728311',NULL,NULL,'2019-03-11',1,1),(2,'Juan','Valverde','Martinez','6693250611','2016030063@upsin.edu.mx','JURA972305vVAMA','7016928311',NULL,NULL,'2019-03-11',2,1),(3,'Carlos','Hernandez','Gaxiola','6694252565','2016030063@upsin.edu.mx','CAAL981507HEGA','7016928331','65184963b4f0c19f14cca0016b5b92ecc62d9df4','Me gusta programar','2019-03-11',3,1),(4,'José','Lora','Peinado','6631842943','2016030063@upsin.edu.mx','JOMA982308LOPA','70169255262',NULL,NULL,'2019-03-11',4,1),(5,'Cesar','Ramirez','Luna','6392299693','2016030063@upsin.edu.mx','CEED990215RALU','7016521196',NULL,NULL,'2019-03-11',5,1),(6,'ada','san','gax','1234567890','2016030023@upsin.edu.mx','3456789VCVJKHGF','34567890765',NULL,NULL,'2019-03-23',11,1),(7,'carlos','hernandez','gaxiola','1928872313','cahernandezgaxiola@gmail.com','OANDOI1928E912E2','27736728389',NULL,NULL,'2019-03-23',12,1),(8,'juan pablo','Hernández Gaxiola','Hernández Gaxiola','8282638276','prueba1@gmail.com','D12ED2VE2C23EVV3','12312312312',NULL,NULL,'2019-03-23',13,1),(9,'prueba','prueba','prueba','4567876542','prueba2@travelopolis.ddns.net','AHSBDH988D2','891278128',NULL,NULL,'2019-03-23',14,0),(10,'prueba','prueba','prueba','6787654678','prueba3@gmail.com','AIBDH817H2D82718','87218278392',NULL,NULL,'2019-03-23',15,0),(11,'prueba','prueba','prueba','6787653678','prueba@gmail.com','KNAINDIU91182918','87265672890',NULL,NULL,'2019-03-23',16,0),(12,'prueba','prueba','prueba','6543456787','prueba7@gmail.com','OAIDN9829182JD91','27653168729',NULL,NULL,'2019-03-23',17,0);
...
insert  into `modulos`(`id`,`nombre`,`descripcion`,`ruta`,`fa_icon`,`status`) values (1,'Inicio','Explora los viajes y tambien crea tu usuario','inicio','fas fa-home',1),(2,'Modulos','Modulo para ver los modulos','admin/Modulos','fas fa-puzzle-piece',1),(3,'Viajeros','Ver listado de viajeros','admin/Viajeros','far fa-user',1),(4,'Viajes','Agregar, editar, eliminar y ver registro de viajes','admin/Viajes','fas fa-plane',1),(5,'Perfiles','Ver, editar y cambiar permisos de perfiles','admin/Perfiles','fas fa-tags',1),(6,'Guias','Agregar, editar, eliminar y listar guias','admin/Guias','fas fa-map',1),(7,'Administradores','Agregar, editar, eliminar y listar administradores','admin/Administradores','fas fa-user-cog',1),(8,'Mi Perfil','Ver datos de mi perfil de usuario','perfil','fas fa-user',1),(9,'Inicio Administrador','Inicio de administrador','administrar','fas fa-cogs',1);
...
insert  into `perfiles_modulos`(`id`,`id_perfil`,`id_modulo`,`f_registro`,`status`) values (18,1,2,NULL,NULL),(19,1,3,NULL,NULL),(20,1,4,NULL,NULL),(21,1,5,NULL,NULL),(22,1,6,NULL,NULL),(23,1,7,NULL,NULL),(24,1,9,NULL,NULL);
...
insert  into `usuarios`(`id`,`usuario`,`contraseña`,`id_perfil`,`f_registro`,`token`,`status`) values (1,'Valeria','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',1,'2019-03-11','',1),(2,'Juan','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',1,'2019-03-11','',1),(3,'Carlos','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',1,'2019-03-11','',1),(4,'Lora','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',2,'2019-03-11','',1),(5,'Cesar','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',2,'2019-03-11','',1),(6,'Linda','1234',3,'2019-03-11','f2lY9wt9Bwo:APA91bGoBxp5FYEaRDOFuBDLSYeAa3WMar8A0ikKfAo9kx663GzDXBVB4eS4Gk5Rv0fWgtROQsjoU7K9IfO9eoRWGISHAOjCrr3qgxQ9OJbicdlxaRFltUPwicKxyHcpTi5nCsyigJ_z',1),(7,'Kimiko','1234',3,'2019-03-11','eYc1g7_iBPQ:APA91bHLH4EdGVW_JHkNruhUkcPE-C_TG3oQEPowFqUPpZ-W6nxgglGTvS7ZIx2h33eLtN2_VyZUyBgo62rcS5B-DV9tXxgm8LPzwAimdXV4BJU-LxRY5zmTJjtWLEofIzU3XSc1b4Kv',1),(8,'inda','c2325b478dfeef64a3088ea3f8f0c0f284173a91',4,'2019-03-11','',1),(9,'joma1998','1234',4,'2019-03-12','raza',1),(10,'valeverga','1234',NULL,NULL,'raza',NULL),(11,'ada','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',2,'2019-03-23',NULL,1),(12,'carlos_gaxiola','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',2,'2019-03-23',NULL,1),(13,'juanpa','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',2,'2019-03-23',NULL,1),(14,'prueba2','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',2,'2019-03-23',NULL,1),(15,'prueba3','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',2,'2019-03-23',NULL,1),(16,'prueba6','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',2,'2019-03-23',NULL,1),(17,'prueba7','7110eda4d09e062aa5e4a390b0a572ac0d2c0220',2,'2019-03-23',NULL,1);
...
CREATE TABLE `viajeros` (
  ...
  `descripcion` text COMMENT 'Descripcion del viajero',
...
insert  into `viajeros`(`id`,`nombre`,`a_paterno`,`a_materno`,`url_foto`,`telefono`,`correo`,`descripcion`,`id_usuario`,`f_registro`,`status`) values (1,'Linda','German','Torres',NULL,'6699276707','2016030063@upsin.edu.mx',NULL,6,'2019-03-11',1),(2,'Alejandro','Castro','Aviles',NULL,'6691002599','2016030063@upsin.edu.mx',NULL,7,'2019-03-11',1),(3,'Armando','Inda','Mellado',NULL,'6692276707','2016030063@upsin.edu.mx',NULL,8,'2019-03-11',1),(4,'LORa','PEINADO','JOSE',NULL,NULL,NULL,NULL,9,NULL,NULL),(5,'$nombre','$apellido_p','$apellido_m','$nueva_foto','$telefono','$correo',NULL,0,'0000-00-00',0),(6,'LORA','LORA','LORA','LORA','LORA','LORA',NULL,1,'0000-00-00',1);
